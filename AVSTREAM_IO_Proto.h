...
typedef enum {
	...
	IOCTRL_TYPE_VIDEO_START = 0x01,
	IOCTRL_TYPE_VIDEO_STOP = 0x02,
    
    IOCTRL_TYPE_VIDEO_SET_RESOLUTION = 0x05, // 设置分辨率
    IOCTRL_TYPE_VIDEO_SELECT_ANALOG_CAMERA =0x06, //选择输入的模拟摄像头，占用1个字节. 0 - camera 1, 1 - camera 2.
