...
#define AP_ERROR_FAILED			0
#define AP_ERROR_SUCC			1
#define AP_ERROR_NOT_INIT		-1
#define AP_ERROR_MAX_INSTANCE	-2
#define AP_ERROR_INVALID_ID		-3
...
// 查找设备回调
//typedef void (/*CALLBACK*/ *SearchDeviceCallBack)(unsigned int nType, unsigned int nLen, const char *szMessage, void *pUser);
// 视频回调
...
#define NET_EVENT_CONNECTTING		0	
#define NET_EVENT_CONNECTED			100	
#define NET_EVENT_CONNECT_ERROR		101	

#define NET_EVENT_ERROR_USER_PWD	1	
#define NET_EVENT_ERROR_MAX_USER	2	
#define NET_EVENT_ERROR_STREAM_ID	3	
#define NET_EVENT_ERROR_VIDEO_LOST	4	
#define NET_EVENT_ERROR_INVALID_ID	5	

#define NET_EVENT_P2P_MODE_RELAY 	6		// P2P 中继模式
#define NET_EVENT_P2P_MODE_P2P		7		// P2P 直连模式

#define NET_EVENT_P2P_NOT_ON_LINE	9
// new: add one macro
#define NET_EVENT_CONNECT_TIMEOUT	10
#define NET_EVENT_DISCONNECT		11
#define NET_EVENT_CHECK_ACCOUNT		12		// 检测账号

#define NET_EVENT_ALARM_CLEAR			0x19
#define NET_EVENT_ALARM_MOTION_START	0x20	
#define NET_EVENT_ALARM_GPIO_START		0x21	
#define NET_EVENT_ALARM_MOTION_END		0x22	
#define NET_EVENT_ALARM_GPIO_END		0x23
#define NET_EVENT_ALARM_AUDIO_START		0x24	

#define NET_EVENT_ALARM_IR				0x25
#define NET_EVENT_ALARM_DOORSENSOR		0x26
#define NET_EVENT_ALARM_SMOKE			0x27
#define NET_EVENT_ALARM_BELLITF			0x28
#define NET_EVENT_ALARM_DOORBELL_PRESS	0x29
...
{	
	...
	char				type;		// i, p,mjpeg, audio
	char				streamid;

	unsigned short 		militime;	
	unsigned int 		sectime;	
	unsigned int    	frameno;	
	unsigned int 		len;		// len=0是报警信息
