...
+ (instancetype)switchWithStringsArray:(NSArray *)strings hasSliderView:(BOOL )hasSliderView
{
    // to do
    return [[DVSwitch alloc] initWithStringsArray:strings hasSliderView:hasSliderView];
}

- (instancetype)initWithStringsArray:(NSArray *)strings hasSliderView:(BOOL )hasSliderView
{
    self = [super init];
